...
<div class="panel admin-panel">
  ...
  <div class="body-content">
    <form method="post" class="form-x" action="${ctx}/announcementChange">  
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input  input-title" name="title" value="${obj.title}"/>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="field">
          <textarea name="content" class="input  input-content" style="height:250px; border:1px solid #ddd;">${obj.content}</textarea>
          <div class="tips"></div>
        </div>
      </div>
