...
<div class="panel admin-panel">
  ...
  <div class="body-content">
    <form method="post" class="form-x" action="../../disbystu">  
        <div class="label" >
		...
		<div>
				...
				<select id="stu" class="input" name="stuId" 
					style="margin-left:30px;width:200px; float:left; line-height:17px;" onchange="setvalue2(this.value)">
			...
			function setvalue2(studentId){
				$.ajax({
			             ...
			             dataType: "json",
			             success:function(data){
			             	var sex = document.getElementById("sex1").options;
