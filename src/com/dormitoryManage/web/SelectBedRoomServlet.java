...
public class SelectBedRoomServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
			...
			List<Bedroom> bedrooms = service.getBedrooms(apmId);
			response.setCharacterEncoding("utf-8");
			response.getWriter().print(JSONArray.fromObject(bedrooms).toString());
	}
